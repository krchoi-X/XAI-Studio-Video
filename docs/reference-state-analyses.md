...
총 38건. 증거의 출처는 항목별로 밝힌다: 프롬프트에서 읽은 것은
...
- 프레임 분석 항목: 18·19·21·22·23·24·25·26·30·31·32·33·34·35·36(임베드
  스크린샷)·37·38(임베드 스크린샷). 24번은 실패 사례.
- 기사 기반: 20·29. 프롬프트 표본(영상 미확인): 27·28.
- 양식 변천: 1–9번은 구 양식(Subject state / Composition / Camera evidence…),
  10–38번은 신 양식(기본 정보 / 관찰 / 관찰 vs 추론 / Control Levels / 기여 패턴).
  원문은 그대로 두고, 양식 차이만 여기서 명시한다.
...
아래는 38개 항목의 "기여 패턴"에서 수확한 후보 목록. 규칙은 "실전 테스트를
